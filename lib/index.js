...
const binaryFilesPath = (binaryFileName) => `${__dirname.replace('app.asar', 'app.asar.unpacked')}/bin/${binaryFileName}`;
...
async function getProcessList() {
  const processListMap = {
    ...
    darwin: getProcessListBin(binaryFilesPath('getProcessListDarwin')),
    linux: getLinuxProc,
  };
